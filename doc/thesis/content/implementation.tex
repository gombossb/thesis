...
default dashboard shows devices, but everything in it

in a typical home env would be more devices, but here one provides almost everything

therefore different functions should be separated eg leds, fans, heating, etc.
